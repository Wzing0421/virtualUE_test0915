...
#define local_audio_port 8001//本地绑定接收语音的端口
...
#define regsendPort 50001 //#向ANC发送注册信息的目的端口
...
const QString mediaGW_addr2 = "162.105.85.198"; //压缩之后的2.4k语音包交给真正的媒体网关
const QString ANC_addr = "162.105.85.47";//#注册和呼叫时候的ANC的目的地址
